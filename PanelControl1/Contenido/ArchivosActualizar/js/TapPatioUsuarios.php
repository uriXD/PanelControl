<?php
  ...
  $idUsuario = $_SESSION['id_usuario'];
   ...
   $sql="SELECT u.IdUsuarios, p.Nombre FROM Usuarios AS u INNER JOIN Personal AS p ON p.IdPersonal1 = u.IdPersonal WHERE u.IdUsuarios = '$idUsuario'";
 ...
 <nav class="navbar navbar-inverse">
  <div class="container">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Informes De Venta
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="#">Ventas Del Dia</a></li>
          <li><a href="#">Ventas En Cierto Periodo</a></li>
          <li><a href="#">Reporte de Suministro</a></li>
      ...
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Platillos
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="#">Lista De Alimentos</a></li>
          <li><a href="#">Agregar Alimento</a></li>
          <li><a href="#">Opciones De Alimentos</a></li>
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="#">Lista De Bebidas</a></li>
          <li><a href="#">Agregar Bebida</a></li>
          <li><a href="#">Opciones De Bebidas</a></li>
        </ul>
      </li>
      ...
      <?php if($_SESSION['tipo_usuario']==1) { ?>
        <li class="dropdown">  
            ...
            <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="ConsultarUsuarios.php">Lista y Opciones Usuarios</a></li>
              <li><a href="../Registro1.php">Agregar Usuario</a></li>
            </ul>
        </li>      
      <?php } ?>
      ...
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Promiciones
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="#">Dar De Alta Una Promo</a></li>
          <li><a href="#">Opciones De promociones</a></li>
          <li><a href="#">Informe De Promos</a></li>
        </ul>
      </li>
	...
	<div class="row">
		<div id="cuadro2" class="col-sm-12 col-md-12 col-lg-12 ocultar">
			<form class="form-horizontal" action="" method="POST">
				...
				<div class="form-group">
					<label for="apellidos" class="col-sm-2 control-label">Tipo Usuario</label>
					<div class="col-sm-8"><input id="IdTipo" name="IdTipo" type="text" class="form-control" maxlength="8" ></div>
				</div>
				<div class="form-group">
